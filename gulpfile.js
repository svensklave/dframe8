(function(){
    ...
    gulp.task('styles-ios', function (cb) {
        var cbs = 0;
        ['dframe8.ios.less', 'dframe8.ios.rtl.less', 'dframe8.ios.colors.less'].forEach(function(lessFilePath, b){
    ...
    gulp.task('styles-material', function (cb) {
        var cbs = 0;
        ['dframe8.material.less', 'dframe8.material.rtl.less', 'dframe8.material.colors.less'].forEach(function(lessFilePath, b){
    ...
    gulp.task('demo-app', function (cb) {
        gulp.src(paths.source.root + 'templates/*.jade')
            .pipe(jade({
                pretty: true,
                locals: {
                    stylesheetFilename: 'dframe8.ios',
                    stylesheetColorsFilename: 'dframe8.ios.colors',
                    scriptFilename: 'dframe8',
                }
            }))
            ...
            .on('end', function () {
                ...
                gulp.src(paths.source.root + 'templates/*.jade')
                    .pipe(jade({
                        pretty: true,
                        locals: {
                            stylesheetFilename: 'dframe8.ios.min',
                            stylesheetColorsFilename: 'dframe8.ios.colors.min',
                            scriptFilename: 'dframe8.min',
                        }
                    }))
                    .pipe(gulp.dest(paths.dist.root));
                // Minify JS
